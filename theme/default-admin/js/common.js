/* added by Kevin Lynx, especially used in ext-blog */
function ext_confirm (id, property) {
    switch (property){
		case 'comment':
		var urlreturn="/manage/comment/delete/"+id;
		var msg = "Are you sure to delete comment "+id;break;
		case 'post':
		var urlreturn="/manage/post/delete/"+id;
		var msg = "Are you sure to delete post "+id;break;
	}
	if(confirm(msg)){window.location = urlreturn;}else {return;}
}
function ext_checkform () {
